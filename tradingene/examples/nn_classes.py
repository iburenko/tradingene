...
def calculate_output(data):
    ...
    for i in range(_lookforward):
        if (data['high'][i] - data['open'][0]) / data['open'][0] > _threshold: # If price breaks the threshold up...
            return [2] # ... it makes class "2"
        elif (data['low'][i] - data['open'][0]) / data['open'][0] < -_threshold: # If price breaks the threshold down...
